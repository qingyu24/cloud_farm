...
public class ConfigLoaderManager {
    ...
    private ArrayList<PlayerLevel> PlayerLevelloader = new ArrayList<PlayerLevel>(20);
    ...
    private ArrayList<WareHouse> WareHouseloader = new ArrayList<WareHouse>(20);
